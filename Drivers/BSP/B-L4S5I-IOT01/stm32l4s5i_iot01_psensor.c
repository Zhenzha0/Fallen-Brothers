...
/**
  * @brief  Read Pressure with full 24-bit precision.
  * @retval LPS22HB measured pressure value in hPa (no integer truncation).
  */
float BSP_PSENSOR_ReadPressureHP(void)
{
  return LPS22HB_P_ReadPressureHP(LPS22HB_I2C_ADDRESS);
}
